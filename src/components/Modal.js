    ...
    return (
        <form ref={formRef} onSubmit={(e) => {
            ...
            <div className='w-full h-[400px] mt-7 overflow-y-scroll hidescrollbar'>
                ...
                These Terms and Conditions govern the use of the AI Companionship Service provided by Sage Fleurs Companionship, a company registered under the laws of Canada
                <br /><br />
